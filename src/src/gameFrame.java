...
public class gameFrame extends JFrame implements java.io.Serializable {
	...
	public gameFrame(int length,int width, ArrayList<String> CorrectFormula) {
		...
		setMinimumSize(new Dimension(721, 630));
		...
		gbl_contentPane.rowHeights = new int[]{0, 50, 50, 50, 50, 50, 50, 50, 86};
		gbl_contentPane.columnWidths = new int[]{0, 0, 0, 0, 0, 0, 0, 52, 0, 99};
	...
	private void initializeKeyboard() {
		...
		exitButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				new Statistics(0, finded?1:0, line+1, tim, true);
		...
		JLabel footer = new JLabel("20011068 Ahmet Akib G\u00DCLTEK\u0130N");
		...
		gbc_footer.insets = new Insets(0, 0, 5, 5);
		gbc_footer.gridx = 8;
		gbc_footer.gridy = 0;
		contentPane.add(footer, gbc_footer);
		contentPane.add(exitButton, gbc_exitButton);
		timerLbl = new JLabel("0:0:0");//timer
		timerLbl.setForeground(Color.WHITE);
		GridBagConstraints gbc_timerLbl = new GridBagConstraints();
		gbc_timerLbl.insets = new Insets(0, 0, 10, 5);
		gbc_timerLbl.gridx = 8;
		gbc_timerLbl.gridy = 2;
		contentPane.add(timerLbl, gbc_timerLbl);
		...
		gbc_KeyboardDiv.insets = new Insets(0, 0, 0, 5);
		gbc_KeyboardDiv.gridx = 6;
		gbc_KeyboardDiv.gridy = 8;
		...
		gbc_KeyboardMult.insets = new Insets(0, 0, 0, 5);
		gbc_KeyboardMult.gridx = 5;
		gbc_KeyboardMult.gridy = 8;
		...
		gbc_KeyboardMinus.insets = new Insets(0, 0, 0, 5);
		gbc_KeyboardMinus.gridx = 4;
		gbc_KeyboardMinus.gridy = 8;
		...
		gbc_KeyboardPlus.insets = new Insets(0, 0, 0, 5);
		gbc_KeyboardPlus.gridx = 3;
		gbc_KeyboardPlus.gridy = 8;
		...
		gbc_Keyboard7.insets = new Insets(0, 0, 0, 5);
		gbc_Keyboard7.gridx = 0;
		gbc_Keyboard7.gridy = 8;
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(guess.controlFormula(guess.charToFormula(guess.guessFormulaChar))) {
					if(guess.finded()) {
				        ...
				        int response = JOptionPane.showOptionDialog(mine, "Tebrikler!!! Oyunu Kazandýnýz\n Tekrar oynamak için ana menüye geri dönebilirsiniz\nSüre: "+timerLbl.getText(), "Ana Menüye Dön", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
						if(response == 0) {
							for(exitListener nl:listeners) {
								nl.exitted();
						...
						KeyboardGuess.setEnabled(false);
						Object[] options = {"Ana Menüye Dön","Sayfada Kal"};
				        int response = JOptionPane.showOptionDialog(mine, "Oyunu Kaybettiniz :) HaHaHa\n Tekrar oynamak için ana menüye geri dönebilirsiniz", "Ana Menüye Dön", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
						if(response == 0) {
							for(exitListener nl:listeners) {
								nl.exitted();
		...
		gbc_Keyboard8.insets = new Insets(0, 0, 0, 5);
		gbc_Keyboard8.gridx = 1;
		gbc_Keyboard8.gridy = 8;
		...
		gbc_Keyboard9.insets = new Insets(0, 0, 0, 5);
		gbc_Keyboard9.gridx = 2;
		gbc_Keyboard9.gridy = 8;
		...
		gbc_KeyboardSonrBitir.insets = new Insets(0, 0, 0, 5);
		gbc_KeyboardSonrBitir.gridx = 8;
		gbc_KeyboardSonrBitir.gridy = 8;
		KeyboardSonrBitir.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				new Statistics(1, 0, 0, 0,true);
				try {
					int i;
		...
		gbc_KeyboardDel.insets = new Insets(0, 0, 0, 5);
		gbc_KeyboardDel.gridx = 7;
		gbc_KeyboardDel.gridy = 8;
